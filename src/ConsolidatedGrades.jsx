                ...
                <tbody className="divide-y divide-gray-200 dark:divide-gray-700 text-sm text-gray-800 dark:text-gray-200">
                  {learnersData.length === 0 ? (
                    ...
                    learnersData.map((learner, idx) => (
                      ...
                      >
                        <td className="px-4 py-3 font-medium text-gray-900 dark:text-gray-100 sticky left-0 z-10 bg-white dark:bg-gray-900 group-hover:bg-inherit break-words max-w-[240px]" title={learner.name}>
