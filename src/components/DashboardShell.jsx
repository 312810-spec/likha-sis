    ...
    <div className="flex min-h-screen bg-gray-50" role="region" aria-label="Dashboard Shell">
      ...
      <main className="flex-1 min-w-0 overflow-x-hidden">
        <div className="flex items-start justify-between gap-4 px-6 py-5 bg-white border-b border-gray-200">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Welcome, <span className="font-medium text-gray-700">{user?.displayName || user?.email || 'Teacher'}</span> — LIKHA-SIS, Tingub National High School
            </p>
          </div>
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="relative" ref={notifRef}>
              <button
                ...
                className="w-9 h-9 flex items-center justify-center rounded-full hover:bg-gray-100 text-gray-600 relative"
              >
                <Bell size={20} />
              </button>
        ...
        <section aria-label="Main" className="p-4 md:p-6">
          {children ? children : <p className="text-gray-500">Select a section from the sidebar to begin.</p>}
        </section>
      </main>
    </div>
  );
